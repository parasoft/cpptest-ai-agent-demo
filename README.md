...
> **Tip:** Consider using a Docker container as your GitHub self-hosted runner with C/C++test and the AI agent pre-installed. This makes environment setup reproducible and shareable across machines.

## Workflow

### 1. Preparation
1. Fork or copy this repository.
2. Set up and connect a GitHub self-hosted runner — see [Prerequisites](#prerequisites) above.
...
4. Open a pull request on GitHub to merge your `feature` branch into `master`.
