...
# Analyze
cpptestcli -compiler gcc_13-64 -config "builtin://Recommended Rules" -module . -input cpptestscan.bdf
...
# Analyze
# cpptestcli -compiler gcc_13-64 -config "builtin://Recommended Rules" -module . -input .build/compile_commands.json
